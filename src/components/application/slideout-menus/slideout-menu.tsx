        ...
        <AriaModalOverlay
            ...
            className={(state) =>
                cx(
                    ...
                    state.isEntering && "duration-500 animate-in fade-in",
                    state.isExiting && "duration-700 animate-out fade-out",
    ...
    <AriaModal
        ...
        className={(state) =>
            cx(
                ...
                state.isEntering && "duration-500 animate-in slide-in-from-right",
                state.isExiting && "duration-700 animate-out slide-out-to-right",
                typeof props.className === "function" ? props.className(state) : props.className,
            )
        }
    />
