...
export default function AddInventory() {
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "var(--color-bg-primary)", color: "var(--color-fg-primary)" }}>
        <h1 className="text-2xl font-bold mb-6">Add inventory</h1>

        <div className="max-w-2xl">
          <div className="mb-6">
            <label className="block text-sm mb-2" style={{ color: "var(--color-fg-secondary)" }}>
              Item name <span style={{ color: "var(--color-fg-error-primary)" }}>*</span>
            </label>
            <input
              type="text"
              value={itemName}
            ...
            <div className="space-y-4 mt-4 text-black">
              {variants.map((variant, index) => (
                <div key={index} className="flex gap-4 items-start">
                  <div className="flex-1">
                    <label className="block text-sm text-gray-700">Variations</label>
                    <input
                      type="text"
                      value={variant.name}
                      onChange={(e) => {
                  ...
                  <div className="w-32">
                    <label className="block text-sm text-gray-700">Inventory</label>
                  ...
                  <div className="w-32">
                    <label className="block text-sm text-gray-700">Price ($) SGD</label>
                    <input
                      type="number"
                      value={variant.price}
                      onChange={(e) => {
