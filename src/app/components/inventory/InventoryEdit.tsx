    ...
    <div className="fixed inset-y-0 right-0 w-[315px] bg-white shadow-xl transform transition-transform duration-300 ease-in-out flex flex-col">
      ...
      <div className="flex flex-col justify-between items-center p-2 border-b">
        <div className="flex justify-between w-full">
          <span className="text-base text-black p-2 font-semibold">
            {item.item_name}
          </span>
          <button
            onClick={onClose}
        ...
        <div
          className="w-full h-48 relative rounded-lg overflow-hidden hover:scale-105 transition-all duration-300"
          style={{
            cursor: "pointer",
            backgroundImage: `url(${
              item.image
        ...
        <div className="flex items-center gap-2 justify-between w-full">
          ...
          <span className="text-lg font-semibold text-gray-700 p-2">
            ${item.price?.price_list_rate.toFixed(2)}
          </span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="text-xs">
                ...
                <select
                  className="p-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-purple-500 border-slate-400 text-black"
            ...
            <div className="grid grid-cols-2 gap-2 w-full">
              <div className="text-xs">
                <p className="text-gray-500">
                  Current quantity: {item.actual_qty}
                </p>
                ...
                <p className="text-gray-500 mt-2">
                  New quantity: {item.actual_qty + quantity}
                </p>
              </div>
              {/* <div className="text-xs"> */}
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs">
              <p className="text-gray-500">
                Current price: ${item.price?.price_list_rate.toFixed(2)}
              </p>
