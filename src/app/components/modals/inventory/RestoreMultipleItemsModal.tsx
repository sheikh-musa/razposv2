    ...
    return (
       <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
                ...
                <h3 className="text-black text-lg font-medium text-center mb-2">Restore Multiple Items</h3>
                <p className="text-gray-500 text-center mb-6">
                    Are you sure you want to restore {itemCount} selected items?
                </p>
                <p className="text-gray-500 text-center text-sm mb-6">This items will be available in the inventory again</p>
